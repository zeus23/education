    ...
    return (
      <div className="class-notes-list-section">
        <div className="class-notes-heading">
          <h1>
            List Of Notes For Class <span>{item}</span>
          </h1>
        </div>
...
export default compose(
  ...
  firestoreConnect((props) => {
    if (props) {
      ...
      return [{ collection: "notes", where: ["class", "==", props.item] }];
    }
  })
)(VideoDetails);
